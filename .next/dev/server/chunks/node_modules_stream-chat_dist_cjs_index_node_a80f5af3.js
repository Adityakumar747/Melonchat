module.exports = [
"[project]/node_modules/stream-chat/dist/cjs/index.node.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
// src/base64.ts
var import_base64_js = __turbopack_context__.r("[project]/node_modules/base64-js/index.js [app-route] (ecmascript)");
...
// src/client.ts
var import_axios3 = __toESM(__turbopack_context__.r("[project]/node_modules/axios/dist/node/axios.cjs [app-route] (ecmascript)"));
var import_https = __toESM(__turbopack_context__.r("[externals]/https [external] (https, cjs)"));
// src/utils.ts
var import_form_data = __toESM(__turbopack_context__.r("[project]/node_modules/form-data/lib/form_data.js [app-route] (ecmascript)"));
// src/constants.ts
...
function isFileWebAPI(uri) {
    return ("TURBOPACK compile-time value", "undefined") !== "undefined" && "File" in window && uri instanceof File;
}
function isOwnUser(user) {
    return user?.total_unread_count !== void 0;
}
function isBlobWebAPI(uri) {
    return ("TURBOPACK compile-time value", "undefined") !== "undefined" && "Blob" in window && uri instanceof Blob;
}
...
function isOnline() {
    const nav = typeof navigator !== "undefined" ? navigator : ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : void 0;
    if (!nav) {
...
var import_linkifyjs = __turbopack_context__.r("[project]/node_modules/linkifyjs/dist/linkify.mjs [app-route] (ecmascript)");
var DEFAULT_LINK_PREVIEW_MANAGER_CONFIG = {
    debounceURLEnrichmentMs: 1500,
    enabled: false,
    findURLFn: (text)=>(0, import_linkifyjs.find)(text, "url", {
...
// src/connection.ts
var import_isomorphic_ws = __toESM(__turbopack_context__.r("[project]/node_modules/isomorphic-ws/node.js [app-route] (ecmascript)"));
// src/insights.ts
var import_axios = __toESM(__turbopack_context__.r("[project]/node_modules/axios/dist/node/axios.cjs [app-route] (ecmascript)"));
...
var postInsights = async (insightType, insights)=>{
    ...
    for(let i = 0; i < maxAttempts; i++){
        try {
            await import_axios.default.post(`https://chat-insights.getstream.io/insights/${insightType}`, insights);
        } catch (e) {
            await sleep((i + 1) * 3e3);
            continue;
        }
...
// src/signing.ts
var import_jsonwebtoken = __toESM(__turbopack_context__.r("[project]/node_modules/jsonwebtoken/index.js [app-route] (ecmascript)"));
...
var import_axios2 = __toESM(__turbopack_context__.r("[project]/node_modules/axios/dist/node/axios.cjs [app-route] (ecmascript)"));
...
var StreamChat = class _StreamChat {
     ...
     */ this._buildWSPayload = (client_request_id)=>JSON.stringify({
        ...
        this.browser = typeof inputOptions.browser !== "undefined" ? inputOptions.browser : ("TURBOPACK compile-time value", "undefined") !== "undefined";
...
var import_axios4 = __turbopack_context__.r("[project]/node_modules/axios/dist/node/axios.cjs [app-route] (ecmascript)");
...
//# sourceMappingURL=node_modules_stream-chat_dist_cjs_index_node_a80f5af3.js.map