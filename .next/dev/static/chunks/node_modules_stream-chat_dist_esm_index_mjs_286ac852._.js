...
"[project]/node_modules/stream-chat/dist/esm/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var encodeBase64 = (data)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$base64$2d$js$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromByteArray"])(new Uint8Array(map(data, (char)=>char.charCodeAt(0))));
var decodeBase64 = (s)=>{
...
var LOCAL_MESSAGE_FIELDS = Object.freeze({
    error: true
});
...
var localMessageToNewMessagePayload = (localMessage)=>{
    const { // Remove all timestamp fields and client-specific fields.
    // Field pinned_at can therefore be earlier than created_at as new message payload can hold it.
    created_at, updated_at, deleted_at, // Client-specific fields
    error, status, // Reaction related fields
    latest_reactions, own_reactions, reaction_counts, reaction_scores, reply_count, // Message text related fields that shouldn't be in update
    command, html, i18n, quoted_message, mentioned_users, // Message content related fields
    ...messageFields } = localMessage;
    return {
        ...messageFields,
...
var deleteUserMessages = ({ messages, user, hardDelete = false, deletedAt })=>{
    for(let i = 0; i < messages.length; i++){
        ...
        if (message.user?.id === user.id) {
            messages[i] = message.type === "deleted" ? message : toDeletedMessage({
                message,
                hardDelete,
                deletedAt
            });
...
var messagePaginationCreatedAtAround = ({ parentSet, requestedPageSize, returnedPage, messagePaginationOptions })=>{
    const newPagination = {
...
var messagePaginationIdAround = ({ parentSet, requestedPageSize, returnedPage, messagePaginationOptions })=>{
    const newPagination = {
        ...parentSet.pagination
    };
...
var messagePaginationLinear = ({ parentSet, requestedPageSize, returnedPage, messagePaginationOptions })=>{
    const newPagination = {
        ...parentSet.pagination
    };
    let hasPrev;
...
var ChannelState = class {
   ...
   */ removePinnedMessage(message) {
    ...
    _addReactionToState(messageFromState, reaction, enforce_unique) {
        ...
        messageFromState.latest_reactions = enforce_unique ? [
            ...(messageFromState.latest_reactions || []).filter((r)=>r.user_id !== userId),
            reaction
        ] : [
            ...messageFromState.latest_reactions || [],
            reaction
        ];
   ...
   */ filterErrorMessages() {
        ...
        for (const message of blockedMessages){
            this._channel.getClient().offlineDb?.hardDeleteMessage({
                id: message.id
            });
        }
   ...
   */ findMessage(messageId, parentMessageId) {
    ...
    findTargetMessageSet(newMessages, addIfDoesNotExist = true, messageSetToAddToIfDoesNotExist = "current") {
        ...
        if (addIfDoesNotExist) {
            ...
            switch(messageSetToAddToIfDoesNotExist){
                case "new":
                    if (overlappingMessageSetIndicesByMsgIds.length > 0) {
                        ...
                        const setIngestIndex = this.findMessageSetByOldestTimestamp(// eslint-disable-next-line @typescript-eslint/no-non-null-assertion
            ...
            const mergeSourceMessageSetIndices = [
                ...overlappingMessageSetIndicesByMsgIds
            ];
...
var CooldownTimer = class extends WithSubscriptions {
     ...
     */ this.setOwnLatestMessageDate = (date)=>{
        ...
        this.recalculate = ()=>{
            ...
            const timeSinceOwnLastMessage = ownLatestMessageDate != null ? // prevent negative values
            Math.max(0, (Date.now() - ownLatestMessageDate.getTime()) / 1e3) : void 0;
...
var createPostUploadAttachmentEnrichmentMiddleware = ()=>({
        ...
        handlers: {
            postProcess: ({ state, discard, forward, next })=>{
...
var MiddlewareExecutor = class {
    ...
    async executeMiddlewareChain({ eventName, initialValue, mode = "cancelable" }) {
        ...
        const execute = async (i, state, status)=>{
            ...
            index = i;
            const returnFromChain = i === this.middleware.length || status && [
                "complete",
                "discard"
            ].includes(status);
...
var createUploadErrorHandlerMiddleware = (composer)=>({
        ...
        handlers: {
            postProcess: ({ state, discard, forward })=>{
...
var createUploadConfigCheckMiddleware = (composer)=>({
        ...
        handlers: {
            prepare: async ({ state, next, discard })=>{
...
var createBlockedAttachmentUploadNotificationMiddleware = (composer)=>({
        ...
        handlers: {
            prepare: ({ state: { attachment }, forward })=>{
...
var DEFAULT_LINK_PREVIEW_MANAGER_CONFIG = {
    ...
    enabled: false,
    findURLFn: (text)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$linkifyjs$2f$dist$2f$linkify$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["find"])(text, "url", {
...
var linkPreviewArrayToMap = (linkPreviews)=>new Map(linkPreviews.map((linkPreview)=>[
            linkPreview.og_scrape_url,
            linkPreview
        ]));
var initState3 = ({ message })=>message ? {
    ...
    constructor({ composer, message }){
        ...
        this._findAndEnrichUrls = async (text)=>{
            ...
            this.state.partialNext({
                previews: new Map([
                    ...keptPreviews,
                    ...linkPreviewArrayToMap(newLinkPreviews)
                ])
            });
...
var defaultPollFieldChangeEventValidators = {
    name: ({ currentError, value })=>value && currentError ? {
            name: void 0
        } : {
...
var createAttachmentsCompositionMiddleware = (composer)=>({
        ...
        handlers: {
            compose: ({ state, next, discard, forward })=>{
                const { attachmentManager } = composer;
...
var createCompositionValidationMiddleware = (composer)=>({
        ...
        handlers: {
            compose: async ({ state, discard, forward })=>{
...
var createPollOnlyCompositionMiddleware = (composer)=>({
        ...
        handlers: {
            compose: ({ state, complete, forward })=>{
...
var BaseSearchSourceBase = class {
    ...
    getStateAfterQuery(stateUpdate, isFirstPage) {
        ...
        return {
            ...
            ...stateUpdate,
            isLoading: false,
            items: isFirstPage ? stateUpdate.items : [
                ...this.items ?? [],
                ...stateUpdate.items || []
            ]
        };
...
var MessageSearchSource = class extends BaseSearchSource {
    ...
    async query(searchQuery) {
        if (!this.client.userID || !searchQuery || this.next === null) return {
            items: []
        };
...
var getTokenizedSuggestionDisplayName = ({ displayName, searchToken })=>({
        tokenizedDisplayName: {
            token: searchToken,
            parts: searchToken ? displayName.split(new RegExp(`(${escapeRegExp(searchToken)})`, "gi")).filter(Boolean) : [
                displayName
            ]
        }
    });
...
var _MessageComposer = class _MessageComposer extends WithSubscriptions {
    ...
    constructor({ composition, config, compositionContext, client }){
        ...
        this.refreshId = ()=>{
            this.state.partialNext({
                id: _MessageComposer.generateId()
            });
        };
        ...
        this.subscribeMessageComposerSetupStateChange = ()=>{
            let tearDown = null;
            const unsubscribe = this.client._messageComposerSetupState.subscribeWithSelector(({ setupFunction: setup })=>({
                    setup
                }), ({ setup })=>{
                tearDown?.();
                tearDown = setup?.({
        ...
        this.subscribeTextComposerStateChanged = ()=>this.textComposer.state.subscribeWithSelector(({ text })=>[
                    text
        ...
        const mergeChannelConfigCustomizer = (originalVal, channelConfigVal, key)=>typeof originalVal === "object" ? void 0 : originalVal === false && key === "enabled" ? false : [
                ...
                "boolean",
                "symbol"
            ].includes(// prevent enabling features that are disabled server-side
            typeof channelConfigVal) ? channelConfigVal : originalVal;
        this.configState = new StateStore(mergeWith(mergeWith(DEFAULT_COMPOSER_CONFIG, config ?? {}), {
            location: {
...
var MessageReceiptsTracker = class {
    ...
    /** Build initial state from server snapshots (single pass + sort). */ ingestInitial(responses) {
        this.byUser.clear();
        this.readSorted = [];
        this.deliveredSorted = [];
    ...
    /** message.delivered — user device confirmed delivery up to and including messageId. */ onMessageDelivered({ user, deliveredAt, lastDeliveredMessageId }) {
    ...
    /** message.read — user read up to and including messageId. */ onMessageRead({ user, readAt, lastReadMessageId }) {
   ...
   */ onNotificationMarkUnread({ user, lastReadAt, lastReadMessageId }) {
    ...
    /** All users who READ this message. */ readersForMessage(msgRef) {
        const index = findIndex(this.readSorted, msgRef, ({ lastReadRef })=>lastReadRef);
        return this.readSorted.slice(index).map((x)=>x.user);
    }
    /** All users who have it DELIVERED (includes readers). */ deliveredForMessage(msgRef) {
    ...
    /** Users who delivered but have NOT read. */ deliveredNotReadForMessage(msgRef) {
        const pos = findIndex(this.deliveredSorted, msgRef, ({ lastDeliveredRef })=>lastDeliveredRef);
    ...
    /** Users for whom `msgRef` is their *last read* (exact match). */ usersWhoseLastReadIs(msgRef) {
    ...
    /** Users for whom `msgRef` is their *last delivered* (exact match). */ usersWhoseLastDeliveredIs(msgRef) {
        if (!msgRef.msgId) return [];
   ...
   */ async query(options = {}, messageSetToAddToIfDoesNotExist = "current") {
        ...
        if (typeof state.channel.config?.shared_locations !== "undefined") {
            this.messageComposer.updateConfig({
                location: {
                    enabled: state.channel.config.shared_locations
                }
            });
        }
        ...
        const areCapabilitiesChanged = [
            ...state.channel.own_capabilities || []
        ].sort().join() !== [
        ...
        this.getClient().syncDeliveredCandidates([
            this
        ]);
        return state;
    }
    ...
    _handleChannelEvent(event) {
        ...
        switch(event.type){
            ...
            case "user.messages.deleted":
                if (event.user) {
                    this.state.deleteUserMessages(event.user, !!event.hard_delete, new Date(event.created_at ?? Date.now()));
                }
                break;
            case "message.new":
                if (event.message) {
...
var postInsights = async (insightType, insights)=>{
    ...
    for(let i = 0; i < maxAttempts; i++){
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`https://chat-insights.getstream.io/insights/${insightType}`, insights);
        } catch (e) {
            await sleep((i + 1) * 3e3);
            continue;
        }
...
var StableWSConnection = class {
   ...
   */ async _connect() {
        ...
        try {
            ...
            this.ws = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$isomorphic$2d$ws$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](wsURL);
...
function CheckSignature(body, secret, signature) {
    const key = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(secret, "utf8");
    const hash = import_crypto.default.createHmac("sha256", key).update(body).digest("hex");
    try {
        return import_crypto.default.timingSafeEqual(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(hash), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(signature));
    } catch  {
        return false;
    }
}
    ...
    constructor({ client }){
        ...
        /** @private */ this._req = async (params, config, retry)=>{
            if (!this.cancelToken && !params.close) {
                this.cancelToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].CancelToken.source();
            }
            try {
...
var Moderation = class {
   ...
   */ async checkUserProfile(userId, profile) {
        ...
        if (profile.username) {
            moderationPayload.texts = [
                profile.username
            ];
        }
        if (profile.image) {
            moderationPayload.images = [
                profile.image
            ];
        }
...
function mapPollStateToResponse(poll) {
    ...
    lastActivityAt, // eslint-disable-next-line @typescript-eslint/no-unused-vars
    maxVotedOptionIds, ownVotesByOptionId, ownAnswer, ...restState } = poll.data;
    const ownVotes = [
...
var ChannelManager = class extends WithSubscriptions {
    constructor({ client, eventHandlerOverrides = {}, options = {}, queryChannelsOverride }){
        ...
        this.setChannels = (valueOrFactory)=>{
            ...
            const { channels, pagination: { filters, sort } } = this.state.getLatestValue();
        ...
        this.executeChannelsQuery = async (payload, retryCount = 0)=>{
            ...
            try {
                const channels = await this.queryChannelsRequest(filters, sort, options, stateOptions);
        ...
        this.loadNext = async ()=>{
            ...
            try {
                ...
                const nextChannels = await this.queryChannelsRequest(filters, sort, options, this.stateOptions);
...
var NotificationManager = class {
    ...
    add({ message, origin, options = {} }) {
        ...
        this.store.partialNext({
            notifications: [
                ...this.store.getLatestValue().notifications,
                notification
            ]
        });
...
var _ReminderManager = class _ReminderManager extends WithSubscriptions {
    constructor({ client, config }){
        ...
        this.subscribePaginatorStateUpdated = ()=>this.paginator.state.subscribeWithSelector(({ items })=>[
                    items
                ], ([items])=>{
                if (!items) return;
        ...
        this.subscribeConfigStateUpdated = ()=>this.configState.subscribeWithSelector(({ stopTimerRefreshBoundaryMs })=>({
...
var StreamChat = class _StreamChat {
     ...
     */ this._handleUserEvent = (event)=>{
            ...
            if (event.type === "user.deleted" && event.user.deleted_at && (event.mark_messages_deleted || event.hard_delete)) {
                this._deleteUserMessageReference(event.user, event.hard_delete, event.user.deleted_at ? new Date(event.user.deleted_at) : null);
            }
        };
        this._callClientListeners = (event)=>{
            const client = this;
     ...
     */ this._buildWSPayload = (client_request_id)=>JSON.stringify({
        ...
        this.mutedChannels = [];
        this.mutedUsers = [];
        this.blockedUsers = new StateStore({
            userIds: []
        });
        ...
        this.axiosInstance = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create(this.options);
        this.setBaseURL(this.options.baseURL || "https://chat.stream-io-api.com");
        if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== "undefined" && "env" in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.STREAM_LOCAL_TEST_RUN) {
            this.setBaseURL("http://localhost:3030");
        }
        if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== "undefined" && "env" in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.STREAM_LOCAL_TEST_HOST) {
            this.setBaseURL("http://" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.STREAM_LOCAL_TEST_HOST);
        }
        ...
        this.messageDeliveryReporter = new MessageDeliveryReporter({
            client: this
        });
    }
   ...
   */ async updateAppSettings(options) {
        ...
        if (apn_config?.p12_cert) {
            options = {
                ...
                apn_config: {
                    ...apn_config,
                    p12_cert: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(apn_config.p12_cert).toString("base64")
                }
            };
        }
   ...
   */ async revokeUserToken(userID, before) {
        return await this.revokeUsersToken([
            userID
        ], before);
    }
    /**
   ...
   */ createToken(userID, exp, iat) {
    ...
    _handleClientEvent(event) {
        ...
        if (event.type === "user.messages.deleted" && !event.cid && event.user) {
            this._deleteUserMessageReference(event.user, event.hard_delete, event.created_at ? new Date(event.created_at) : null);
        }
        if (event.type === "health.check" && event.me) {
            ...
            client.blockedUsers.partialNext({
                userIds: event.me.blocked_user_ids ?? []
            });
        }
   ...
   */ async queryFutureChannelBans(options = {}) {
        return await this.get(this.baseURL + "/query_future_channel_bans", {
            payload: options
        });
    }
    /**
   ...
   */ async getHookEvents(products) {
        const params = products && products.length > 0 ? {
   ...
   */ async partialUpdateUser(partialUserObject) {
        return await this.partialUpdateUsers([
            partialUserObject
        ]);
    }
    /**
   ...
   */ async removeShadowBan(targetUserID, options) {
    ...
    async getBlockedUsers(user_id) {
        const result = await this.get(this.baseURL + "/users/block", {
            ...user_id ? {
                user_id
            } : {}
        });
   ...
   */ // fixme: remove the signature with optionsOrHardDelete boolean with the next major release
    ...
    async _deleteMessage(messageID, optionsOrHardDelete) {
        const { deleteForMe, hardDelete } = typeof optionsOrHardDelete === "boolean" ? {
   ...
   */ channelBatchUpdater() {
    ...
    validateServerSideAuth() {
        if (!this.secret) {
            throw new Error("This feature can be used server-side only. Please initialize the client with a secret to use this feature.");
        }
    }
    /**
...
var OfflineDBSyncManager = class {
     ...
     */ this.sync = async ()=>{
            ...
            try {
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isAxiosError"])(e) && e.code === "ECONNABORTED") {
                    return;
                }
                const error = e;
...
var AbstractOfflineDB = class {
     ...
     */ this.handleRemoveMessage = async ({ messageId, execute = true })=>{
            ...
            const queries = [
                ...dropPendingTasksQueries,
                ...hardDeleteMessageQueries
            ];
            if (execute) {
...
var _LiveLocationManager = class _LiveLocationManager extends WithSubscriptions {
    ...
    async assureStateInit() {
        ...
        this.state.next({
            messages: new Map(active_live_locations.filter((location)=>!isExpiredLocation(location)).map((location)=>[
                    location.message_id,
                    {
                        ...location,
    ...
    subscribeTargetMessagesChange() {
        ...
        const unsubscribe = this.state.subscribeWithSelector(({ messages })=>({
                messages
            }), ({ messages })=>{
            if (!messages.size) {
    ...
    subscribeLiveLocationSharingUpdates() {
        const subscriptions = [
            ...
            this.client.on("live_location_sharing.stopped", (event)=>{
                ...
                this.unregisterMessages([
                    event.live_location?.message_id
                ]);
            })
        ];
...
//# sourceMappingURL=node_modules_stream-chat_dist_esm_index_mjs_286ac852._.js.map