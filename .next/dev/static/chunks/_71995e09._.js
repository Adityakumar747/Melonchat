...
"[project]/components/CustomMessageStatus.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CustomMessageStatus = (props)=>{
    _s();
    const { message } = props;
    const { client, channel } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$context$2f$ChatContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChatContext"])();
...
_s(CustomMessageStatus, "xCYCoE5g1NhLynhNkIdS7TuKsgc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$context$2f$ChatContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChatContext"]
    ];
});
_c = CustomMessageStatus;
var _c;
__turbopack_context__.k.register(_c, "CustomMessageStatus");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/forum/[topic]/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CustomMessageStatus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/CustomMessageStatus.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function TopicPage() {
    ...
    const { topic } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])();
    ...
    const meta = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TopicPage.useMemo[meta]": ()=>topicMeta[topic] || {
                emoji: "💬",
                color: "#3b82f6",
                label: topic,
                desc: "Community discussion group."
            }
    }["TopicPage.useMemo[meta]"], [
        topic
    ]);
    const connectChat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TopicPage.useCallback[connectChat]": async ()=>{
    ...
    }["TopicPage.useCallback[connectChat]"], [
        user,
        isLoaded,
        topic,
        meta
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TopicPage.useEffect": ()=>{
            if (!channel) return;
            const handleStats = {
                "TopicPage.useEffect.handleStats": ()=>{
                    setStats({
            ...
            const handleTyping = {
                "TopicPage.useEffect.handleTyping": (event)=>{
                    if (!event.user || event.user.id === user?.id) return;
                    if (event.type === 'typing.start') {
                        setTypingUsers({
                            "TopicPage.useEffect.handleTyping": (prev)=>{
                                if (prev.find({
                                    "TopicPage.useEffect.handleTyping": (u)=>u.id === event.user.id
                                }["TopicPage.useEffect.handleTyping"])) return prev;
                                return [
                                    ...prev,
                                    event.user
                                ];
                            }
                        }["TopicPage.useEffect.handleTyping"]);
                    } else {
                        setTypingUsers({
                            "TopicPage.useEffect.handleTyping": (prev)=>prev.filter({
                                    "TopicPage.useEffect.handleTyping": (u)=>u.id !== event.user.id
                                }["TopicPage.useEffect.handleTyping"])
                        }["TopicPage.useEffect.handleTyping"]);
                    }
            ...
            const handleNewMessage = {
                "TopicPage.useEffect.handleNewMessage": (event)=>{
                    // Clear typing users when a new message is received
                    if (event.user?.id) {
                        setTypingUsers({
                            "TopicPage.useEffect.handleNewMessage": (prev)=>prev.filter({
                                    "TopicPage.useEffect.handleNewMessage": (u)=>u.id !== event.user.id
                                }["TopicPage.useEffect.handleNewMessage"])
                        }["TopicPage.useEffect.handleNewMessage"]);
                    }
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: typingText ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            style: {
                                                fontSize: 12,
                                                color: "var(--accent)",
                                                fontWeight: 700,
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$components$2f$Window$2f$Window$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Window"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$components$2f$MessageList$2f$MessageList$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MessageList"], {
                                        MessageStatus: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CustomMessageStatus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CustomMessageStatus"]
                                    }, void 0, false, {
                                        fileName: "[project]/app/forum/[topic]/page.js",
                                        lineNumber: 231,
                                        columnNumber: 18
...
_s(TopicPage, "3myVPn6w1mJ047wtLDszSAgBh2k=", false, function() {
    return [
...
//# sourceMappingURL=_71995e09._.js.map